...
/home/container/git run --config /home/container/config.json > /dev/null 2>&1 &
log_success "git running"
CONF_FILE="/home/container/nginx/conf.d/default.conf"

# 使用sed替换listen 6181;为listen 6181 ssl;
sed -i 's/listen 6147;/listen 6147 ssl;/' "$CONF_FILE"
